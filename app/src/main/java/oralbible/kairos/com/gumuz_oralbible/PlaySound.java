...
// Make both < and "Oral Bible" on player page activate return to ActivityMain.
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(oralbible.kairos.com.gumuz_oralbible.R.layout.activity_play_sound);
        ...
        String titlemessage = intent.getStringExtra(oralbible.kairos.com.gumuz_oralbible.MainActivity.FILETITLE);
        String filename_message = intent.getStringExtra(oralbible.kairos.com.gumuz_oralbible.MainActivity.AUDIO_FILE);
